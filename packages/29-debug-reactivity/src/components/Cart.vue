...
// BUG 1: the total is right on the first render and never again.
const total = ref(lines.value.reduce((sum, line) => sum + line.price, 0))

// BUG 2: this one reorders the cart itself every time it is read.
